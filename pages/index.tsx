...
export default function Home() {
      ...
      <div className="flex justify-center lg:items-center w-full h-full">
        <div className="grid grid-cols-1 lg:grid-cols-3 rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-col gap-10 max-w-[400px] p-16 bg-[#e28525]">
            ...
            <button className="bg-white text-[#e28525] hover:bg-[#e28525] hover:text-white border-solid border-2 p-4 font-lex-deca rounded-full mt-16 w-36" >Learn More</button>
          </div>
  ...
  and off-road adventures.</p>
            <button className="bg-white text-[#016972] hover:bg-[#016972] hover:text-white border-solid border-2 p-4 font-lex-deca rounded-full mt-16 w-36" >Learn More</button>
          </div>
  ...
  rental and arrive in style.</p>
            <button className="bg-white text-[#00403f] hover:bg-[#00403f] hover:text-white text-border-solid border-2 p-4 font-lex-deca rounded-full mt-16 w-36" >Learn More</button>
          </div>
        </div>
      </div>
    </>
